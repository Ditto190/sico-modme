...
| **20260825** | Release | Released [**Sico v0.4.0**](https://github.com/microsoft/Sico/releases/tag/v0.4.0), introducing RBAC, scheduled tasks, Digital Worker management, and AgentStream. |
| **20260722** | Release | Released [**Sico v0.3.0**](https://github.com/microsoft/Sico/releases/tag/v0.3.0), introducing multi-session chat, project context management and experience improvements. |
